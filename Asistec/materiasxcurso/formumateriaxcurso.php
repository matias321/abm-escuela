		...
		if($_GET['oper'] == 1)
		{
			...
			?>
				<div align="center">
					...
					<form action="mensamateriasxcurso.php?oper=<?php echo $operacion?>" method="post">
						<br>
						<br>
						...
						<select name="cmbmateriaxcurso" id="cmbmateriaxcurso" required>
						...
						<script language="javascript">
							 $(document).ready(function(){
								 $("#cmbcurso").click(function(){
								  ...
								  $("#cmbgrupo").click(function(){
									$("#cmbgrupo option:selected").each(function(){
										id_grupo = $(this).val();
